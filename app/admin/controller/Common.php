...
class Common extends BaseController
{
    ...
    {
        // 设置标题
        $this->setPageTitle(Config::get('admin.title'));

        // 后台菜单
        $this->assign('menus', Config::get('admin.menu'));
    ...
    protected function fetch($template, $renderContent = false)
    {
        ...
        return Collection::fetch($template, $renderContent);
    }
